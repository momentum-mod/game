...
CAmmoDef *GetAmmoDef()
{
    ...
    if (!bInitted)
    {
        ...
        def.AddAmmoType("GaussEnergy", DMG_SHOCK, TRACER_NONE, 0, 0, "sk_max_gauss_round", BULLET_IMPULSE(650, 8000), 0); // hit like a 10kg weight at 400 in/s
        def.AddAmmoType("CombineCannon", DMG_BULLET, TRACER_LINE, "sk_npc_dmg_gunship_to_plr", "sk_npc_dmg_gunship", NULL, 1.5 * 750 * 12, 0); // hit like a 1.5kg weight at 750 ft/s
        def.AddAmmoType("AirboatGun", DMG_AIRBOAT, TRACER_LINE, "sk_plr_dmg_airboat", "sk_npc_dmg_airboat", NULL, BULLET_IMPULSE(10, 600), 0);
        def.AddAmmoType("Rifle", DMG_ENERGYBEAM, TRACER_BEAM, 10, 0, -2, BULLET_IMPULSE(200, 1225), 0);
        //=====================================================================
        ...
        def.AddAmmoType("HelicopterGun", DMG_BULLET, TRACER_LINE_AND_WHIZ, 0, 0, "sk_max_smg1", BULLET_IMPULSE(400, 1225), AMMO_FORCE_DROP_IF_CARRIED | AMMO_INTERPRET_PLRDAMAGE_AS_DAMAGE_TO_PLAYER);
