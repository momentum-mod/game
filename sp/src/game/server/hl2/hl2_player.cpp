...
void CHL2_Player::PreThink(void)
{
	...
	//		if (target)
	//		{
	//			CTakeDamageInfo dmg(this, this, 900.0f, DMG_GENERIC);
...
CBaseEntity* CHL2_Player::EntSelectSpawnPoint()
{
	CBaseEntity *pSpot;
	pSpot = NULL;
...
bool CHL2_Player::SelectSpawnSpot(const char *pEntClassName, CBaseEntity* &pSpot)
{
...
* dismount.
*/
void CHL2_Player::SurpressLadderChecks(const Vector& pos, const Vector& normal)
{
...
*/
bool CHL2_Player::CanGrabLadder(const Vector& pos, const Vector& normal)
{
