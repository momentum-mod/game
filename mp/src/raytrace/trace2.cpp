...
static ALIGN16 int32 signmask[4]={(int32)0x80000000,(int32)0x80000000,(int32)0x80000000,(int32)0x80000000};
				...
				switch(lmode)
				{
					...
					case DIRECT_LIGHTING_WITH_SHADOWS:
					{
						...
						for(int l=0;l<LightList.Count();l++)
						{
							...
							FourRays myraysPerLight;
                            myraysPerLight.origin=surface_pos;
							FourVectors epsilon=ldir;
							epsilon*=0.01;
                            myraysPerLight.origin+=epsilon;
                            myraysPerLight.direction=ldir;
							RayTracingResult shadowtest;
							Trace4Rays(myraysPerLight,Four_Zeros,MaxT, &shadowtest);
