...
void base64_encode(void *pInput, unsigned int in_len, char *pOutput, size_t outLen)
{
    unsigned char *bytes_to_encode = static_cast<unsigned char *>(pInput);
    CUtlVector<char> ret;
    int i = 0;
    int j = 0;
