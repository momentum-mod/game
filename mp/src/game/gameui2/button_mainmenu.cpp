...
void Button_MainMenu::Animations()
{
	...
	if (m_sButtonStateOld != m_sButtonState && m_pAnimController != nullptr)
	{
		...
		{
			case Out:
				m_pAnimController->RunAnimationCommand(this, "m_fWidth", m_fWidthOut, 0.0f, m_fAnimationWidth, AnimationController::INTERPOLATOR_LINEAR);
				m_pAnimController->RunAnimationCommand(this, "m_fHeight", m_fHeightOut, 0.0f, m_fAnimationHeight, AnimationController::INTERPOLATOR_LINEAR);
				m_pAnimController->RunAnimationCommand(this, "m_cBackground", m_cBackgroundOut, 0.0f, m_fAnimationBackground, AnimationController::INTERPOLATOR_LINEAR);
				m_pAnimController->RunAnimationCommand(this, "m_cBackgroundOutline", m_cBackgroundOutlineOut, 0.0f, m_fAnimationBackground, AnimationController::INTERPOLATOR_LINEAR);
				m_pAnimController->RunAnimationCommand(this, "m_cText", m_cTextOut, 0.0f, m_fAnimationText, AnimationController::INTERPOLATOR_LINEAR);
				m_pAnimController->RunAnimationCommand(this, "m_cDescription", m_cDescriptionOut, 0.0f, m_fAnimationDescription, AnimationController::INTERPOLATOR_LINEAR);
				m_pAnimController->RunAnimationCommand(this, "m_cBackgroundBlurAlpha", m_bBackgroundBlurOut ? Color(255, 255, 255, 255) : Color(0, 0, 0, 0), 0.0f, m_fAnimationBackground, AnimationController::INTERPOLATOR_LINEAR);
				break;

			case Over:
				m_pAnimController->RunAnimationCommand(this, "m_fWidth", m_fWidthOver, 0.0f, m_fAnimationWidth, AnimationController::INTERPOLATOR_LINEAR);
				m_pAnimController->RunAnimationCommand(this, "m_fHeight", m_fHeightOver, 0.0f, m_fAnimationHeight, AnimationController::INTERPOLATOR_LINEAR);
				m_pAnimController->RunAnimationCommand(this, "m_cBackground", m_cBackgroundOver, 0.0f, m_fAnimationBackground, AnimationController::INTERPOLATOR_LINEAR);
				m_pAnimController->RunAnimationCommand(this, "m_cBackgroundOutline", m_cBackgroundOutlineOver, 0.0f, m_fAnimationBackground, AnimationController::INTERPOLATOR_LINEAR);
				m_pAnimController->RunAnimationCommand(this, "m_cText", m_cTextOver, 0.0f, m_fAnimationText, AnimationController::INTERPOLATOR_LINEAR);
				m_pAnimController->RunAnimationCommand(this, "m_cDescription", m_cDescriptionOver, 0.0f, m_fAnimationDescription, AnimationController::INTERPOLATOR_LINEAR);
				m_pAnimController->RunAnimationCommand(this, "m_cBackgroundBlurAlpha", m_bBackgroundBlurOver ? Color(255, 255, 255, 255) : Color(0, 0, 0, 0), 0.0f, m_fAnimationBackground, AnimationController::INTERPOLATOR_LINEAR);
				break;

			case Pressed:
				m_pAnimController->RunAnimationCommand(this, "m_fWidth", m_fWidthPressed, 0.0f, m_fAnimationWidth, AnimationController::INTERPOLATOR_LINEAR);
				m_pAnimController->RunAnimationCommand(this, "m_fHeight", m_fHeightPressed, 0.0f, m_fAnimationHeight, AnimationController::INTERPOLATOR_LINEAR);
				m_pAnimController->RunAnimationCommand(this, "m_cBackground", m_cBackgroundPressed, 0.0f, m_fAnimationBackground, AnimationController::INTERPOLATOR_LINEAR);
				m_pAnimController->RunAnimationCommand(this, "m_cBackgroundOutline", m_cBackgroundOutlinePressed, 0.0f, m_fAnimationBackground, AnimationController::INTERPOLATOR_LINEAR);
				m_pAnimController->RunAnimationCommand(this, "m_cText", m_cTextPressed, 0.0f, m_fAnimationText, AnimationController::INTERPOLATOR_LINEAR);
				m_pAnimController->RunAnimationCommand(this, "m_cDescription", m_cDescriptionPressed, 0.0f, m_fAnimationDescription, AnimationController::INTERPOLATOR_LINEAR);
				m_pAnimController->RunAnimationCommand(this, "m_cBackgroundBlurAlpha", m_bBackgroundBlurPressed ? Color(255, 255, 255, 255) : Color(0, 0, 0, 0), 0.0f, m_fAnimationBackground, AnimationController::INTERPOLATOR_LINEAR);
				break;

			case Released:
				m_pAnimController->RunAnimationCommand(this, "m_fWidth", m_fWidthReleased, 0.0f, m_fAnimationWidth, AnimationController::INTERPOLATOR_LINEAR);
				m_pAnimController->RunAnimationCommand(this, "m_fHeight", m_fHeightReleased, 0.0f, m_fAnimationHeight, AnimationController::INTERPOLATOR_LINEAR);
				m_pAnimController->RunAnimationCommand(this, "m_cBackground", m_cBackgroundReleased, 0.0f, m_fAnimationBackground, AnimationController::INTERPOLATOR_LINEAR);
				m_pAnimController->RunAnimationCommand(this, "m_cBackgroundOutline", m_cBackgroundOutlineReleased, 0.0f, m_fAnimationBackground, AnimationController::INTERPOLATOR_LINEAR);
				m_pAnimController->RunAnimationCommand(this, "m_cText", m_cTextReleased, 0.0f, m_fAnimationText, AnimationController::INTERPOLATOR_LINEAR);
				m_pAnimController->RunAnimationCommand(this, "m_cDescription", m_cDescriptionReleased, 0.0f, m_fAnimationDescription, AnimationController::INTERPOLATOR_LINEAR);
				m_pAnimController->RunAnimationCommand(this, "m_cBackgroundBlurAlpha", m_bBackgroundBlurReleased ? Color(255, 255, 255, 255) : Color(0, 0, 0, 0), 0.0f, m_fAnimationBackground, AnimationController::INTERPOLATOR_LINEAR);
				break;
