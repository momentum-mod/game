#ifndef _MOM_ENTITYOUTPUT_H_
#define _MOM_ENTITYOUTPUT_H_
...
#ifdef CLIENT_DLL
	#define CEventAction C_EventAction
	#define COutputEvent C_OutputEvent
	#define CBaseEntityOutput C_BaseEntityOutput
	#define CEntityOutputTemplate C_EntityOutputTemplate

	#define COutputVariant C_OutputVariant
	#define COutputInt C_OutputInt
	#define COutputFloat C_OutputFloat
	#define COutputString C_OutputString
	#define COutputEHANDLE C_OutputEHANDLE
