...
BEGIN_PREDICTION_DATA(CRotButton)
END_PREDICTION_DATA();

#undef CRotButton // Undefine so we can type the real server class name for recv table

IMPLEMENT_CLIENTCLASS_DT(C_RotButton, DT_RotButton, CRotButton)
END_RECV_TABLE();
#define CRotButton C_RotButton // Redefine for rest of the code
#else // Server save data and send table
IMPLEMENT_SERVERCLASS_ST(CRotButton, DT_RotButton)
END_SEND_TABLE();
...
#ifdef CLIENT_DLL // Client prediction and recv table
BEGIN_PREDICTION_DATA(CMomentaryRotButton)
END_PREDICTION_DATA();

#undef CMomentaryRotButton // Undefine so we can type the real server class name for recv table

IMPLEMENT_CLIENTCLASS_DT(C_MomentaryRotButton, DT_MomentaryRotButton, CMomentaryRotButton)
END_RECV_TABLE();
#define CMomentaryRotButton C_MomentaryRotButton // Redefine for rest of the code
#else // Server save data and send table
IMPLEMENT_SERVERCLASS_ST(CMomentaryRotButton, DT_MomentaryRotButton)
END_SEND_TABLE();
