	...
	bool bWireframe )
{
	...
	if( bWireframe )
	{
		IMaterial *pWireMaterial = m_pParticleMgr->m_pMaterialSystem->FindMaterial( "debug/debugparticlewireframe", TEXTURE_GROUP_OTHER );
		pRenderContext->Bind( pWireMaterial, NULL );
	}
	else
	{
