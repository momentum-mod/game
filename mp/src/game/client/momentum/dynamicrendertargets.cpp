...
void CDynamicRenderTargets::PreRender()
{
...
ITexture* CDynamicRenderTargets::CreateDepthBufferTexture()
{
    ...
    ITexture* textureTF2DepthBuffer = m_pMaterialSystem->FindTexture("_rt_ResolvedFullFrameDepth", TEXTURE_GROUP_RENDER_TARGET);
...
EXPOSE_SINGLE_INTERFACE_GLOBALVAR(CDynamicRenderTargets, IClientRenderTargets, CLIENTRENDERTARGETS_INTERFACE_VERSION, g_DynamicRenderTargets);
