...
CrosshairSettingsPage::CrosshairSettingsPage(Panel *pParent) : BaseClass(pParent, "CrosshairSettings")
{
    ...
    m_pCompareFormat = new CvarToggleCheckButton(this, "CompareFormat", "#MOM_Settings_Compare_Format",
                                                 "mom_comparisons_format_output");
    ...
    m_pTimeShowOverall = new CvarToggleCheckButton(this, "TimeShowOverall", "#MOM_Settings_Compare_Show_Overall",
    ...
    m_pTimeShowZone = new CvarToggleCheckButton(this, "TimeShowZone", "#MOM_Settings_Compare_Show_Zone",
                                                "mom_comparisons_time_show_perzone");
    m_pTimeShowZone->GetTooltip()->SetTooltipFormatToSingleLine();
    m_pTimeShowZone->AddActionSignalTarget(this);

    m_pVelocityShow =
        new CvarToggleCheckButton(this, "VelShow", "#MOM_Settings_Compare_Show_Velocity", "mom_comparisons_vel_show");
    m_pVelocityShow->AddActionSignalTarget(this);
    m_pVelocityShowAvg = new CvarToggleCheckButton(this, "VelShowAvg", "#MOM_Settings_Compare_Show_Velocity_Avg",
                                                   "mom_comparisons_vel_show_avg");
    m_pVelocityShowAvg->AddActionSignalTarget(this);
    m_pVelocityShowMax = new CvarToggleCheckButton(this, "VelShowMax", "#MOM_Settings_Compare_Show_Velocity_Max",
                                                   "mom_comparisons_vel_show_max");
    m_pVelocityShowMax->AddActionSignalTarget(this);
    m_pVelocityShowEnter = new CvarToggleCheckButton(this, "VelShowEnter", "#MOM_Settings_Compare_Show_Velocity_Enter",
                                                     "mom_comparisons_vel_show_enter");
    m_pVelocityShowEnter->GetTooltip()->SetTooltipFormatToSingleLine();
    m_pVelocityShowEnter->AddActionSignalTarget(this);
    m_pVelocityShowExit = new CvarToggleCheckButton(this, "VelShowExit", "#MOM_Settings_Compare_Show_Velocity_Exit",
                                                    "mom_comparisons_vel_show_exit");
    m_pVelocityShowExit->GetTooltip()->SetTooltipFormatToSingleLine();
    m_pVelocityShowExit->AddActionSignalTarget(this);

    m_pSyncShow =
        new CvarToggleCheckButton(this, "SyncShow", "#MOM_Settings_Compare_Show_Sync", "mom_comparisons_sync_show");
    m_pSyncShow->AddActionSignalTarget(this);
    m_pSyncShowS1 = new CvarToggleCheckButton(this, "SyncShowS1", "#MOM_Settings_Compare_Show_Sync1",
                                              "mom_comparisons_sync_show_sync1");
    m_pSyncShowS1->GetTooltip()->SetTooltipFormatToSingleLine();
    m_pSyncShowS1->AddActionSignalTarget(this);
    m_pSyncShowS2 = new CvarToggleCheckButton(this, "SyncShowS2", "#MOM_Settings_Compare_Show_Sync2",
                                              "mom_comparisons_sync_show_sync2");
    m_pSyncShowS2->GetTooltip()->SetTooltipFormatToSingleLine();
    m_pSyncShowS2->AddActionSignalTarget(this);

    m_pJumpShow =
        new CvarToggleCheckButton(this, "ShowJumps", "#MOM_Settings_Compare_Show_Jumps", "mom_comparisons_jumps_show");
    m_pJumpShow->AddActionSignalTarget(this);
    m_pStrafeShow = new CvarToggleCheckButton(this, "ShowStrafes", "#MOM_Settings_Compare_Show_Strafes",
                                              "mom_comparisons_strafe_show");
...
int CrosshairSettingsPage::DetermineBogusPulse(Panel *panel) const
{
    int bogusPulse = 0;
...
void CrosshairSettingsPage::CursorEnteredCallback(vgui::Panel *panel)
{
...
void CrosshairSettingsPage::CursorExitedCallback(vgui::Panel *panel)
{
