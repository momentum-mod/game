#include "cbase.h"
#include "ultralight_fontloader_win.h"
#include <winlite.h>
#include <tchar.h>
#include <vector>
...
String16 UltralightFontLoaderWin::fallback_font() const
{
  return "Times New Roman";
}

Ref<Buffer> UltralightFontLoaderWin::Load(const String16& family, int weight, bool italic, float size) {
	...
	auto i = m_mapFonts.Find(hash);
	if (i == m_mapFonts.InvalidIndex())
	{
		m_mapFonts.Insert(hash, data);
		return data;
	}
	else
	{
...
{
  return new UltralightFontLoaderWin();
}
