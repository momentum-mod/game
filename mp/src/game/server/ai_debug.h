...
FMTFUNCTION_WIN(3, 4) void DevMsg(CAI_BaseNPC *pAI, unsigned flags, PRINTF_FORMAT_STRING const char *pszFormat, ...) FMTFUNCTION(3, 4);
FMTFUNCTION_WIN(2, 3) void DevMsg(CAI_BaseNPC *pAI, PRINTF_FORMAT_STRING const char *pszFormat, ...) FMTFUNCTION(2, 3);
