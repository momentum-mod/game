...
void CMomentumReplaySystem::SetReplayInfo()
{
    ...
    // TODO: Stages precision fix aswell
    replay->SetStartTick(m_iStartTimerTick - m_iStartRecordingTick + TIME_TO_TICKS(g_Timer->m_flTickOffsetFix[1] - (gpGlobals->interval_per_tick - g_Timer->m_flTickOffsetFix[0])));
}
