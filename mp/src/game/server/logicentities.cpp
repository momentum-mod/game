...
protected:
	...
	virtual void UpdateOutValue(CBaseEntity *pActivator, float fNewValue);
...
class CLogicPlayerInfo : public CLogicalEntity
{
	DECLARE_CLASS( CLogicPlayerInfo, CLogicalEntity );
public:
