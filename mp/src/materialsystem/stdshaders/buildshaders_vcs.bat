...
if not exist "..\..\devtools\bin\shadercompile\standalone\ShaderCompile.exe" goto NoShaderCompile
set ChangeToDir=%SrcDirBase%\devtools\bin\shadercompile\standalone
...
:NoShaderCompile
echo - ERROR: ShaderCompile.exe doesn't exist in devtools\bin\shadercompile\standalone
goto end
...
powershell -NoLogo -ExecutionPolicy Bypass -Command "%SrcDirBase%\devtools\bin\shadercompile\standalone\process_shaders.ps1 -Version %SHVER% '%inputbase%.txt'"
