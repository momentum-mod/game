...
set BUILD_SHADER=call buildshaders_vcs.bat
set ARG_EXTRA=

%BUILD_SHADER% momentum_dx9_20b -game %GAMEDIR% -source %SOURCEDIR%	-20
%BUILD_SHADER% momentum_dx9_30 -game %GAMEDIR% -source %SOURCEDIR% -force30 -30 -force
