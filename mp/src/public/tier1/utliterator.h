...
//-----------------------------------------------------------------------------
// Container must implement ElemType_t, IndexType_t, const and non-const begin(), end(), Element(idx), and const
// IteratorNext(idx)
//-----------------------------------------------------------------------------
template <typename Container, bool bConstIterator> class CUtlForwardIteratorImplT
{
  public:
    ...
    typedef typename CUtlIteratorBase_SelectIf<bConstIterator, const typename Container::ElemType_t,
                                               typename Container::ElemType_t>::type value_type;
  ...
  protected:
    ...
    friend Container;
    CUtlForwardIteratorImplT(Container_t *pContainer, IndexType_t iElement)
        : m_pContainer(pContainer), m_iElement(iElement)
    {
    }
};
...
class CUtlBidirectionalIteratorImplT : public CUtlForwardIteratorImplT<Container, bConstIterator>
{
  ...
  protected:
    friend Container;
    CUtlBidirectionalIteratorImplT(typename Base::Container_t *pContainer, typename Base::IndexType_t iElement)
        : Base(pContainer, iElement)
    {
    }
};
